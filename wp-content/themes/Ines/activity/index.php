	...
	<div id="content">
		...
		<div class="breaks">
			...
			<?php if ( !is_user_logged_in() ) : ?>
				...
				<h3><?php _e( 'Our Activity', 'buddypress' ); ?></h3>
          ...
          <a href="<?php bp_activity_directory_permalink(); ?>" title="<?php _e( 'The public activity for everyone on this site.', 'buddypress' ); ?>">
          <?php printf( __( 'All Members <span>%s</span>', 'buddypress' ), bp_get_total_member_count() ); ?></a>
          </li>
