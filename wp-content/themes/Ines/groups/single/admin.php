...
?>
			...
			<div class="hp">
				<?php echo bp_core_fetch_avatar( array( 'item_id' => bp_get_member_user_id(), 'type' => 'full', 'width' => 125, 'height' => 125, 'alt' => sprintf( __( 'Profile picture of %s', 'buddypress' ), bp_get_member_name() ) ) ); ?>
					<div class="x"></div>
      </div>
        <h2>
					<a href="<?php bp_member_permalink(); ?>"> <?php bp_member_name(); ?> (<?php _e( 'Administrator', 'buddypress' ); ?>)</a>
					<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
					<span class="small mask">
						<a class="button confirm admin-demote-to-member info" href="<?php bp_group_member_demote_link( bp_get_member_user_id() ); ?>">
            <?php _e( 'Demote to Member', 'buddypress' ); ?></a>
					</span>			
					<?php endif; ?>
				</h2>		
			</div>
...
?>
        ...
        <h2>
							<a href="<?php bp_member_permalink(); ?>"> <?php bp_member_name(); ?> (<?php _e( 'Moderator', 'buddypress' ); ?>)</a>
              	</h2>
							<span class="small mask">
								<a href="<?php bp_group_member_promote_admin_link( array( 'user_id' => bp_get_member_user_id() ) ); ?>" class="info button confirm mod-promote-to-admin" title="<?php _e( 'Promote to Admin', 'buddypress' ); ?>"><?php _e( 'Promote to Admin', 'buddypress' ); ?></a>
...
?>
				...
				<div class="<?php echo $style_classes[$style_index++ % $styles_count]; ?> view view-first">
			<div class="hp">
						<?php bp_group_member_avatar('type=full&amp;width=125&amp;height=125'); ?>
        	<div class="x"></div>
      </div>
						<h2>
							<?php bp_group_member_link(); ?> (<?php _e( 'Member', 'buddypress' ); ?>)
             </h2>
							...
							<?php if ( bp_get_group_member_is_banned() ) : ?>
								...
								<a href="<?php bp_group_member_unban_link(); ?>" class="info button confirm member-unban" title="<?php _e( 'Unban this member', 'buddypress' ); ?>"><?php _e( 'Remove Ban', 'buddypress' ); ?></a>

							<?php else : ?>

								<a href="<?php bp_group_member_ban_link(); ?>" class="info button confirm member-ban" title="<?php _e( 'Kick and ban this member', 'buddypress' ); ?>"><?php _e( 'Kick &amp; Ban', 'buddypress' ); ?></a>
								<a href="<?php bp_group_member_promote_mod_link(); ?>" class="info button confirm member-promote-to-mod" title="<?php _e( 'Promote to Mod', 'buddypress' ); ?>"><?php _e( 'Promote to Mod', 'buddypress' ); ?></a>
								<a href="<?php bp_group_member_promote_admin_link(); ?>" class="info button confirm member-promote-to-admin" title="<?php _e( 'Promote to Admin', 'buddypress' ); ?>"><?php _e( 'Promote to Admin', 'buddypress' ); ?></a>

							<?php endif; ?>

								<a href="<?php bp_group_member_remove_link(); ?>" class="info button confirm" title="<?php _e( 'Remove this member', 'buddypress' ); ?>"><?php _e( 'Remove from group', 'buddypress' ); ?></a>
